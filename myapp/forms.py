...
class TipForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['date', 'amount', 'cash_made', 'hours_worked', 'note']
        widgets = {
            ...
            'hours_worked': forms.NumberInput(attrs={'step': '0.01', 'placeholder': '0.0', 'class': 'mt-1 block w-full px-3 py-2 bg-stone-700 border border-stone-600 rounded-md text-white placeholder-stone-400 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm'}),
